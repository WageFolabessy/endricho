      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-10">
        ...
        <article className="bg-white rounded-lg p-6 shadow-sm text-gray-900">
          ...
          <section className="mt-4 space-y-2">
            <h3 className="text-lg font-semibold">1) Judul & Pernyataan Masalah</h3>
          ...
          <section className="mt-4 space-y-2">
            <h3 className="text-lg font-semibold">2) Tumpukan Teknologi & Alasan</h3>
        ...
        <article className="bg-white rounded-lg p-6 shadow-sm text-gray-900">
          ...
          <section className="mt-4 space-y-2">
            <h3 className="text-lg font-semibold">3) Tantangan & Solusi</h3>
            <h4 className="font-medium">Tantangan 1 — Autentikasi Admin + Protected Routes (Sanctum, CSRF, Expired Token)</h4>
            ...
            <p className="font-medium">Dampak:</p>
            <ul className="list-disc pl-6 space-y-1">
        ...
        <article className="bg-white rounded-lg p-6 shadow-sm text-gray-900">
          ...
          <section className="mt-4 space-y-2">
            ...
            <p className="font-medium">Catatan Dampak:</p>
            <ul className="list-disc pl-6 space-y-1">
        ...
        <article className="bg-white rounded-lg p-6 shadow-sm text-gray-900">
          ...
          <section className="mt-4 space-y-2">
            <h3 className="text-lg font-semibold">3) Tantangan & Solusi (Teknis)</h3>
            <h4 className="font-medium">Tantangan 1: Validasi multi-form eksemplar buku</h4>
            <ul className="list-disc pl-6 space-y-1">
              <li>
            ...
            <h4 className="font-medium">Tantangan 2: Filter rentang tanggal + ekspor Excel</h4>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h4 className="font-medium">Tantangan 3: Integrasi push notification (FCM)</h4>
            <ul className="list-disc pl-6 space-y-1">
